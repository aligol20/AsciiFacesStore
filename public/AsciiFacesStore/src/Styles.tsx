...
export const styles = StyleSheet.create({
  ...
  price: {color: 'yellow', textAlign: 'left', width: '100%', fontSize: 13},
  size: {color: 'white', textAlign: 'left', width: '100%', fontSize: 13},
  date: {color: '#4ffff4', textAlign: 'left', width: '100%', fontSize: 13},
  main_view: {
    alignItems: 'center',
    justifyContent: 'center',
    flexDirection: 'column',
